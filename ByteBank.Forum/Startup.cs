        ...
        public void Configuration(IAppBuilder builder)
        {
            ...
            builder.CreatePerOwinContext<UserManager<UsuarioAplicacao>>(
                (opcoes, contextoOwin) =>
                {
                    ...
                    userManager.RegisterTwoFactorProvider(ConfigurationManager.AppSettings["provider:two_factor_signIn"],
                                                          new PhoneNumberTokenProvider<UsuarioAplicacao> { MessageFormat = "Codigo de Autenticacao: {0}" });
                ...
                Provider = new CookieAuthenticationProvider
                {
                    OnValidateIdentity = SecurityStampValidator
                                         ...
                                         (TimeSpan.FromSeconds(0),
                                          (manager, usuario) => manager.CreateIdentityAsync(usuario,
